...
const Header = (props) => {
  const divId1 = props.divID1;
  const divId2 = props.divID2;
  ...
  function LocomotiveAnimations() {
    ...
    const locoScroll = new LocomotiveScroll({
      el: document.querySelector(divId1),
      smooth: true,
    });
    ...
    ScrollTrigger.scrollerProxy(divId1, {
      scrollTop(value) {
      ...
      pinType: document.querySelector(divId1).style.transform
        ? "transform"
        : "fixed",
    });
